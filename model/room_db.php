<!-- ********** room_db.php **********
     Purpose: Various functions related
     to both student view and projector
     view of a quiz. 
     Programmers: Matt Nelson and Sean Anderson
     **********************************
-->
...
/*** getTotalUserCount ***
 *      Purpose:    Pulls total count of attendees in a given roster.
 *      Parameters: $roomID - The id used to access the Room
 *      Returns:    $attendeeCount - The count of attendees
 *                  OR -1 upon error.
 *      Programmer: Sean Anderson
 */
